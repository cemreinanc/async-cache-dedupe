...
const StorageUpstash = proxyquire('../src/storage/upstash', {
  '../util': {
...
test('storage upstash', async (t) => {
  test('should get an instance with default options', async (t) => {
    const storage = createStorage('upstash', { client: redisClient })
  ...
  test('should throw on missing options', async (t) => {
    t.throws(() => createStorage('upstash'))
  })

  test('should throw on invalid options, missing client', async (t) => {
    t.throws(() => createStorage('upstash', { client: -1 }))
  })

  test('should throw on invalid options, invalid referenceTTL', async (t) => {
    t.throws(() => createStorage('upstash', { client: {}, invalidation: { referencesTTL: -1 } }))
  })
  ...
  test('get', async (t) => {
    ...
    test('should not throw on error', async (t) => {
      t.plan(3)
      const storage = createStorage('upstash', {
        client: {},
        log: {
          debug: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.get error')
  ...
  test('set', async (t) => {
    ...
    test('should set a value with references', async (t) => {
      const storage = createStorage('upstash', { client: redisClient, invalidation: true })
    ...
    test('should set a custom references ttl', async (t) => {
      const storage = createStorage('upstash', { client: redisClient, invalidation: { referencesTTL: 10 } })
      await storage.set('foo', 'bar', 100, ['fooers'])
    ...
    test('should get a warning setting references with invalidation disabled', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          warn: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.set, invalidation is disabled, references are useless')
          }
        }
      })
    ...
    test('should not throw on error', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.set error')
            t.equal(error.key, 'foo')
          }
        }
      })
    ...
    test('should not throw on error', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.remove error')
            t.equal(error.key, 'foo')
          }
        }
      })
    ...
    test('should get a warning with invalidation disabled', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          warn: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.invalidate, exit due invalidation is disabled')
          }
        }
      })
    ...
    test('should not throw on error', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.invalidate error')
    ...
    test('should not throw on error', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.clear error')
    ...
    test('should not throw on error', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.refresh error')
          }
        }
      })
    ...
    test('should get a warning calling with empty key', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          warn: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.clearReferences invalid call due to empty key')
          }
        }
      })
    ...
    test('should not throw on error', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.clearReferences error')
          }
        }
      })
  ...
  test('gc', async (t) => {
    test('should get a warning calling on disabled invalidation', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          debug: () => { },
          warn: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.gc does not run due to invalidation is disabled')
          }
        }
      })
    ...
    test('should not throw on error', async (t) => {
      ...
      const storage = createStorage('upstash', {
        ...
        log: {
          ...
          warn: () => { },
          error: (error) => {
            t.equal(error.msg, 'acd/storage/upstash.gc error')
          }
        }
      })
    ...
    test('should not throw on invalid options, chunk', async (t) => {
      t.plan(2)
      const storage = createStorage('upstash', { client: {}, invalidation: true })
    ...
    test('lazy mode', async (t) => {
      ...
      test('should get stats on lazy run', async (t) => {
        const storage = new StorageUpstash({ client: redisClient, invalidation: true })
